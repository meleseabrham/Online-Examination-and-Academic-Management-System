 ...
 */
export const calculateCourseTotals = async (req: Request, res: Response) => {
 ...
 */
export const calculateSemesterRankings = async (req: Request, res: Response) => {
    const { academicYearId, semesterId } = req.body;
    try {
        const pool = await poolPromise;
 ...
 */
export const calculateFinalYearResults = async (req: Request, res: Response) => {
 ...
 */
export const getStudentSemesterResults = async (req: Request, res: Response) => {
 ...
 */
export const getSemesterRankings = async (req: Request, res: Response) => {
 ...
 */
export const getAcademicProcessingStatus = async (req: Request, res: Response) => {
    const { academicYearId, semesterId } = req.query;
