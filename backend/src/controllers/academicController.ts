...
export const createSection = async (req: Request, res: Response) => {
    ...
    try {
        ...
        } catch (syncErr) { console.error('Sync Create Error:', syncErr); }
...
export const updateSection = async (req: Request, res: Response) => {
    ...
    try {
        ...
        } catch (syncErr) { console.error('Sync Update Error:', syncErr); }
...
export const deleteSection = async (req: Request, res: Response) => {
    ...
    try {
        ...
        } catch (syncErr) { console.error('Sync Delete Error:', syncErr); }
...
export const assignCourseToGrade = async (req: Request, res: Response) => {
...
export const getUnenrolledStudents = async (req: Request, res: Response) => {
    const { academicYearId } = req.query;
    try {
        const pool = await poolPromise;
        const result = await pool.request()
...
export const enrollStudent = async (req: Request, res: Response) => {
    ...
    try {
        ...
        } catch (syncErr) { console.error('Sync Academic Enroll Error:', syncErr); }
...
export const updateEnrollment = async (req: Request, res: Response) => {
    ...
    try {
        ...
        } catch (syncErr) { console.error('Sync Academic Update Error:', syncErr); }
...
export const deleteEnrollment = async (req: Request, res: Response) => {
    ...
    try {
        ...
        } catch (syncErr) { console.error('Sync Academic Delete Error:', syncErr); }
    ...
    try {
        ...
        try {
            for (const student of students) {
                ...
                if (student.GradeNumber === 12 && isPassed) status = 'Graduated';
                ...
                if (status !== 'Graduated') {
                    ...
                    if (nextGradeId) {
                        ...
                        const match = classMap.find(c =>
                            (c.GradeName === gnStr || c.GradeName === nextGradeNumber.toString()) &&
...
export const calculateSemesterResults = async (req: Request, res: Response) => {
...
/* --- Rankings --- */
export const calculateFinalYearRankings = async (req: Request, res: Response) => {
