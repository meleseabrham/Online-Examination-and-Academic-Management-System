...
// =============================================
export const bulkAssignAssessments = async (req, res) => {
...
export const getAssessments = async (req, res) => {
    ...
    try {
        ...
        if (semesterId) {
            query += ` AND a.SemesterId = @semesterId`;
            request.input('semesterId', sql.Int, semesterId);
        }
        if (gradeId) {
            query += ` AND a.GradeId = @gradeId`;
            request.input('gradeId', sql.Int, gradeId);
        }
        if (academicYearId) {
            query += ` AND a.AcademicYearId = @ayId`;
...
export const getStudentsForAssessment = async (req, res) => {
    const { assessmentId } = req.params;
...
// =============================================
export const calculateWeightedSemesterResults = async (req, res) => {
...
// =============================================
export const getStudentCourseBreakdown = async (req, res) => {
