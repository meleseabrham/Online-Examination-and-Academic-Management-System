...
const AssessmentManagement = () => {
    ...
    const baseUrl = isAdmin ? 'http://localhost:5000/api/admin' : 'http://localhost:5000/api/teacher';
                                    ...
                                    {isAdmin && (
                                        <div className="mt-4 flex items-center gap-4 bg-white/50 p-2 rounded-2xl border border-slate-100 w-fit">
                                            <label className="flex items-center gap-2 cursor-pointer">
                                                ...
                                                <span className="text-xs font-black text-[#1B2559] uppercase tracking-wider">Restrict to Admin Only</span>
                                            </label>
                                        </div>
                                    )}
                                </div>
