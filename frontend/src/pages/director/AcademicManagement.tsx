...
const AcademicManagement = () => {
    ...
    const tabParam = searchParams.get('tab') as 'years' | 'semesters' | 'grades' | 'enrollment' | 'results' | 'promotion' | null;
    ...
    const [activeTab, setActiveTab] = useState<'years' | 'semesters' | 'grades' | 'enrollment' | 'results' | 'promotion'>(tabParam || 'years');

    useEffect(() => {
        if (tabParam && ['years', 'semesters', 'grades', 'enrollment', 'results', 'promotion'].includes(tabParam)) {
    ...
    const fetchProcessingStatus = async (overrideYearId?: string) => {
        ...
        try {
            ...
            const res = await axios.get('http://localhost:5000/api/director/academic-processing-status', { headers, params });
    ...
    const fetchYears = async () => {
        try {
            const res = await axios.get('http://localhost:5000/api/director/academic-years', { headers });
            setYears(res.data);
    ...
    const fetchSemesters = async () => {
        try {
            ...
            const res = await axios.get('http://localhost:5000/api/director/semesters', { headers, params });
    ...
    const fetchSections = async (gradeId?: number) => {
        try {
            ...
            const res = await axios.get('http://localhost:5000/api/director/sections', { headers, params });
    ...
    const fetchGradeCourses = async (gradeId?: number | null, ayId?: string, semId?: string) => {
        try {
            ...
            if (!gId) return;
            const res = await axios.get(`http://localhost:5000/api/director/grade-courses/${gId}?academicYearId=${aId}&semesterId=${sId}`, { headers });
    ...
    const fetchCourses = async () => {
        try {
            const res = await axios.get('http://localhost:5000/api/director/courses', { headers });
            setCourses(res.data);
        } catch (err) { console.error(err); }
    };
    ...
    const fetchUnenrolledStudents = async (ayId: string) => {
        try {
            const res = await axios.get(`http://localhost:5000/api/director/enrollments/unenrolled?academicYearId=${ayId}`, { headers });
    ...
    const fetchEnrollments = async () => {
        try {
            ...
            const res = await axios.get('http://localhost:5000/api/director/enrollments', { headers, params });
    ...
    const handleSubmitYear = async (e: React.FormEvent) => {
        ...
        try {
            if (editingYearId) {
                await axios.put(`http://localhost:5000/api/director/academic-years/${editingYearId}`, yearForm, { headers });
            } else {
                await axios.post('http://localhost:5000/api/director/academic-years', yearForm, { headers });
            }
    ...
    const handleDeleteYear = async (id: number) => {
        setConfirmModal({
            ...
            onConfirm: async () => {
                try {
                    await axios.delete(`http://localhost:5000/api/director/academic-years/${id}`, { headers });
                    fetchYears();
                    setConfirmModal({
                        isOpen: true,
                        title: 'Success',
    ...
    const handleSubmitSemester = async (e: React.FormEvent) => {
        ...
        try {
            if (editingSemesterId) {
                await axios.put(`http://localhost:5000/api/director/semesters/${editingSemesterId}`, semesterForm, { headers });
            } else {
                await axios.post('http://localhost:5000/api/director/semesters', semesterForm, { headers });
            }
    ...
    const handleDeleteSemester = async (id: number) => {
        setConfirmModal({
            ...
            onConfirm: async () => {
                try {
                    await axios.delete(`http://localhost:5000/api/director/semesters/${id}`, { headers });
                    fetchSemesters();
                    setConfirmModal({
                        isOpen: true,
                        title: 'Success',
    ...
    const handleSubmitSection = async (e: React.FormEvent) => {
        ...
        try {
            if (editingSectionId) {
                await axios.put(`http://localhost:5000/api/director/sections/${editingSectionId}`, sectionForm, { headers });
            } else {
                await axios.post('http://localhost:5000/api/director/sections', sectionForm, { headers });
            }
    ...
    const handleDeleteSection = async (id: number) => {
        setConfirmModal({
            ...
            onConfirm: async () => {
                try {
                    await axios.delete(`http://localhost:5000/api/director/sections/${id}`, { headers });
                    fetchSections(selectedGradeId || undefined);
                    setConfirmModal({
                        isOpen: true,
                        title: 'Success',
    ...
    const handleAssignCourse = async (courseId: number) => {
        ...
        try {
            await axios.post('http://localhost:5000/api/director/grade-courses',
                {
    ...
    const handleRemoveCourse = async (courseId: number) => {
        if (!selectedGradeId) return;
        try {
            await axios.delete(`http://localhost:5000/api/director/grades/${selectedGradeId}/courses/${courseId}`, { headers });
    ...
    const handleEnrollStudent = async (e: React.FormEvent) => {
        ...
        try {
            if (editingEnrollmentId) {
                await axios.put(`http://localhost:5000/api/director/enrollments/${editingEnrollmentId}`, {
                ...
                await axios.post('http://localhost:5000/api/director/enrollments', {
    ...
    const handleDeleteEnrollment = async (id: number) => {
        setConfirmModal({
            ...
            onConfirm: async () => {
                try {
                    await axios.delete(`http://localhost:5000/api/director/enrollments/${id}`, { headers });
                    fetchEnrollments();
                    fetchUnenrolledStudents(selectedAYForEnrollment);
                    setConfirmModal({
                        isOpen: true,
    ...
    const handlePromote = async () => {
        ...
        setConfirmModal({
            ...
            onConfirm: async () => {
                setLoading(true);
                try {
                    const response = await axios.post('http://localhost:5000/api/director/promotions', {
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-8 scroll-smooth pt-2">
                    ...
                    <div className="flex items-center gap-1 bg-white p-1 rounded-2xl w-fit mb-8 shadow-sm border border-slate-100 overflow-x-auto max-w-full">
                        {[
                            ...
                            { id: 'promotion', label: 'Promotion', icon: <TrendingUp size={18} /> },
                        ].map(tab => (
                            <button
                                key={tab.id}
                                onClick={() => {
                                            ...
                                            onClick={() => {
                                                ...
                                                setConfirmModal({
                                                    ...
                                                    onConfirm: async () => {
                                                        setLoading(true);
                                                        try {
                                                            await axios.post('http://localhost:5000/api/director/calculate-weighted-course-totals',
                                            ...
                                            onClick={() => {
                                                ...
                                                setConfirmModal({
                                                    ...
                                                    onConfirm: async () => {
                                                        setLoading(true);
                                                        try {
                                                            await axios.post('http://localhost:5000/api/director/calculate-semester-rankings',
                                                                { academicYearId: selectedAYForEnrollment, semesterId: selectedSemesterForResults }, { headers });
                                                            fetchProcessingStatus();
                                                            setConfirmModal({
                                                                isOpen: true,
                                            ...
                                            onClick={() => {
                                                setConfirmModal({
                                                    ...
                                                    onConfirm: async () => {
                                                        setLoading(true);
                                                        try {
                                                            await axios.post('http://localhost:5000/api/director/calculate-final-year-results',
                        ...
                        <div className="max-w-3xl mx-auto animate-in slide-in-from-bottom-4 duration-300">
                            <div className="relative bg-white p-8 rounded-3xl shadow-lg border border-slate-100 overflow-hidden">
                                ...
                                <div className="relative z-10 text-center">
                                    ...
                                    {/* Icon */}
                                    <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-indigo-50 flex items-center justify-center shadow-md">
