                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <select
                                        className="w-full px-5 py-3 rounded-xl border border-slate-100 bg-slate-200 focus:ring-1 focus:ring-brand-blue outline-none transition-all cursor-pointer text-xs"
